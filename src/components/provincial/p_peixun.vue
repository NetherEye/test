			...
			<div class="main_content">
				...
				<div class="table">
					<el-table ref="table" :data="tableData" tooltip-effect="dark" style="width: 99%;" height="100%" header-cell-class-name="tableTou" cell-class-name="tableRow" @selection-change="handleSelectionChange">
						...
						<el-table-column prop="name" label="所属市州" align="center" show-overflow-tooltip>
						</el-table-column>
						<el-table-column prop="address" align="center" label="所属区县" show-overflow-tooltip>
						</el-table-column>
						<el-table-column align="center" label="培训类别" show-overflow-tooltip>
							<template slot-scope="scope">
								<div class="textState1">未审批</div>
							</template>
						</el-table-column>
						<el-table-column align="center" label="培训负责人" show-overflow-tooltip>
							<template slot-scope="scope">
								<div class="textState2">通过</div>
							</template>
						</el-table-column>
						<el-table-column align="center" label="培训负责人电话" show-overflow-tooltip>

						</el-table-column>
						<el-table-column align="center" label="参与人数" show-overflow-tooltip>

						</el-table-column>
						<el-table-column align="center" label="操作" show-overflow-tooltip>
							<template slot-scope="scope">
								<div class="btns">
									<div class="textBtnLook" @click="isXq">查看</div>
									<div class="textBtnLook m">/</div>
									<div class="textBtnLook" @click="isFind">名单</div>
								</div>
							</template>
						</el-table-column>
					</el-table>
