			...
			<div class="main_content">
						...
						<div class="filterBox" v-show="isFilter" style="padding: 36px 50px 46px 50px;">
							<el-form :inline="true" :model="filter" class="demo-form-inline">
								<el-form-item label="景区名称">
									<el-input class="mar" style="width: 517px;" v-model="filter.user" width="80px" placeholder="景区名称" ></el-input>
								</el-form-item>
				...
				<div class="table">
					<el-table ref="table" :data="tableData" tooltip-effect="dark" style="width: 99%;" height="100%" header-cell-class-name="tableTou" cell-class-name="tableRow" @selection-change="handleSelectionChange">
						...
						<el-table-column prop="villagers" label="景区名称" align="center" show-overflow-tooltip>
						</el-table-column>
						<el-table-column prop="city" align="center" label="景区类别" show-overflow-tooltip>
						</el-table-column>
						<el-table-column prop="county" align="center" label="景区融合类型" show-overflow-tooltip>
						</el-table-column>
						<el-table-column prop="name" align="center" label="所属市州" show-overflow-tooltip>
						</el-table-column>
						<el-table-column align="center" label="操作" show-overflow-tooltip>
							<template slot-scope="scope">
								<div class="btns">
									<div class="textBtnLook" @click="goScenic" >查看详情</div>
								</div>
							</template>
						</el-table-column>
					</el-table>
