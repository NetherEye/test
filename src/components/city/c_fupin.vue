						...
						<div class="filterBox" v-show="isFilter" style="padding: 36px 50px 46px 50px;">
							<el-form :inline="true" :model="filter" class="demo-form-inline">
								<el-form-item label="身份证号">
									<el-input class="mar" style="width: 517px;" v-model="filter.user" clearable width="80px" placeholder="身份证号"></el-input>
								</el-form-item>
								<el-form-item label="户籍区县">
									<el-select v-model="filter.region" placeholder="活动区域" clearable style="width: 161px;">
								...
								<el-form-item label="带动贫困人口增收方式">
									<el-select v-model="filter.region" placeholder="活动区域" clearable style="width: 410px;">
										<el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
										</el-option>
									</el-select>
								</el-form-item>
								...
								<el-form-item label="人员状态">
									<el-select v-model="filter.region" placeholder="活动区域" clearable style="width: 125px;">
										<el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
										</el-option>
									</el-select>
								</el-form-item>
								<el-form-item label="填报员">
									<el-select v-model="filter.region" placeholder="活动区域" clearable>
										<el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
										</el-option>
									</el-select>
								</el-form-item>
							...
							<div class="filter_btn">
								...
								<div class="btn btn2">批量导入</div>
								<div class="btn btn3" @click="training">批量导入贫困人口培训信息</div>
							</div>
						</div>
					</el-collapse-transition>
				</div>
