<template>
  <div class="public">
    <div class="box">
      <div class="title">调查问卷列表</div>
      <div class="content">
        <p class="color ft20">短信调研调查问卷列表</p>
        ...
        <div class="item" style="margin-bottom: 34px;">
          <div class="item_item1">
            <p class="color ft18 mar"></p>
            <p>
              问卷名称&nbsp;&nbsp;&nbsp;&nbsp;<el-input v-model="input" placeholder="请输入内容" style="width: 88%" disabled></el-input>
              <button class="btn11">查询</button>
            </p>
          </div>
        </div>
        <div class="table">
