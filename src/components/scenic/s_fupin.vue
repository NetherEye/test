			...
			<div class="main_content">
				...
				<div class="table">
					<el-table ref="table" :data="tableData" tooltip-effect="dark" style="width: 99%;" width="140px" height="100%" header-cell-class-name="tableTou" cell-class-name="tableRow" @selection-change="handleSelectionChange">
						<el-table-column type="selection" width="40px" align="center" show-overflow-tooltip>
						</el-table-column>
						...
						<el-table-column prop="name" align="center" label="户籍镇" width="140px" show-overflow-tooltip>
						</el-table-column>
						...
						<el-table-column prop="name" align="center" label="是否已上传佐证材料" width="200px" show-overflow-tooltip>
						</el-table-column>
						<el-table-column align="center" label="操作" show-overflow-tooltip>
							<template slot-scope="scope">
								<div class="btns">
									<div class="textBtnLook" @click="goFupin">补充资料</div>
								</div>
							</template>
						</el-table-column>
					</el-table>
